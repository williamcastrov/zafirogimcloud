...
class ContactosController extends Controller
{
    ...
    public function create(Request $request){
        try { 
          ...
          $insert['nitinterlocutor_con']    = $request['nitinterlocutor_con'];
      ...
      public function contactosclientes($identificacion_con){
        try { 
          //$data = Frecuencias::find($id_fre);
          $data = DB::select("SELECT t0.*, t1.nombre_est, t2.nombre_ciu
          FROM contactos as t0 INNER JOIN estados as t1 INNER JOIN ciudades as t2
          WHERE t0.estado_con = t1.id_est and t0.ciudad_con = t2.id_ciu and t0.identificacion_con = $identificacion_con");
          ...
          if ($data) {
              ...
              $response['data'] = null;
              $response['message'] = "Not found data identificacion_con => $identificacion_con";
              $response['success'] = false;
          }
          } catch (\Exception $e) {
              $response['message'] = $e->getMessage();
      ...
      public function update(Request $request, $id_con){
        try {
          ...
          $data['nitinterlocutor_con']    = $request['nitinterlocutor_con'];
