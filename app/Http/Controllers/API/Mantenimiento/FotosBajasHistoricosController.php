...
use App\Models\Mantenimiento\FotosBajasHistoricos;

class FotosBajasHistoricosController extends Controller
{
    //
    ...
    public function create(Request $request){
        try { 
          ...
          FotosBajasHistoricos::insert($insert);
      
          $response['message'] = "Fotos Equipos Bajas Historicos Grabado de forma correcta";
      ...
      public function listar_fotosequipos($codigoequipo){  
        try {
            ...
            FROM  fotosbajashistoricos as t0
      ...
      public function update(Request $request, $id){
        try {
          ...
          $res = FotosBajasHistoricos::where("id",$id)->update($data);
      ...
      public function delete($id){ 
        try {
          $res = FotosBajasHistoricos::where("id",$id)->delete($id);
          $response['res'] = $res;
