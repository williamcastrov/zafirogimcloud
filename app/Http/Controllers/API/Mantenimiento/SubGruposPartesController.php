...
class SubGruposPartesController extends Controller
{
    ...
    public function create(Request $request){
        try { 
          ...
          $insert['codigoalterno_sgre']   = $request['codigoalterno_sgre'];
    ...
    public function actualizaconsecutivo(Request $request, $consecutivo){
      try {
        ...
        $res = DB::update('update subgrupopartes 
                           set consecutivo_sgre   = consecutivo_sgre   + 1,
                               codigoalterno_sgre = codigoalterno_sgre + 1 
                         where tipoconsecutivo_sgre = :tipo',['tipo' => $consecutivo]);
    ...
    public function update(Request $request, $id_sgre){
        try {
          ...
          $data['codigoalterno_sgre']   = $request['codigoalterno_sgre'];
