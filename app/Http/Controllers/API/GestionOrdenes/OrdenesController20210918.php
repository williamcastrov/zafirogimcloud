...
ORDER BY id_otr DESC");
          ...
          $palabra = 'tempo';
          //$palabra = substr($data1[1]->observacion_cosv, 0, 500); 
          
          $actividad1 = 'tempo'; //substr($data1[0]->descripcion_cosv, 0, 200);
          $actividad2 = 'tempo'; //substr($data1[1]->descripcion_cosv, 0, 200);
          ...
          <tr>
            ...
            <th align="left">
              HOROMETRO: '.$data2[0]->horometro_otr.'
            </th>
          </tr>
          <tr>
          <br/>
          <th align="right" colspan="2">
            ...
            <th style="text-align: right !important; background-color: #F5F5F5; font-size: 9px !important" colspan="2";  >
          ...
          <table border="0" cellspacing="1" cellpadding="1" style="font-family: Arial, Helvetica, sans-serif !important; font-size: 10px !important;">
            ...
            <tr style="text-align: center !important; background-color: #F5F5F5; font-size: 9px !important" >
              ...
              <td >
                ...
                <br/>
                '.$data1[1]->fechainicia_cosv.'
              </td>
              <td >
                '.$data1[0]->fechafinal_cosv.'
                <br/>
                '.$data1[1]->fechafinal_cosv.'
              </td>
            <td>FECHA_HORA_INICIAL</td>
            <td>FECHA_HORA_FINAL</td>
          </tr>
          ...
          $html .= 
          '<tr>
            <td style = "text-align: center !important; font-size: 10px !important" >'.$data2[0]->iniciatransporte_otr.'</td>
            <td style = "text-align: center !important; font-size: 10px !important" >'.$data2[0]->fechainicia_otr.'</td>
            <td style = "text-align: center !important; font-size: 10px !important" >'.$data2[0]->tiempotransporte_otr.'</td>
            <td style = "text-align: center !important; font-size: 10px !important" >'.$data2[0]->tiempoorden_otr.'</td>
          </tr>';
