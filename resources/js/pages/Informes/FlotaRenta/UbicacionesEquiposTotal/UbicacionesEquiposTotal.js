...
function UbicacionesEquiposTotal() {
                        ...
                        listarUbicacionesMT && listarUbicacionesMT.map((hojavida, index) => {
                            return (
                                <tr>
                                    ...
                                    <td>{hojavida.serie_dequ}</td>
                                    <td>{hojavida.referencia_dequ}</td>
                                    <td>{hojavida.modelo_dequ}</td>
...
export default UbicacionesEquiposTotal;