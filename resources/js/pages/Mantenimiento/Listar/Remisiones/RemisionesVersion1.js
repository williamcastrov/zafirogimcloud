...
function Remisiones() {
  ...
  const exportarAPdf = () => {
    ...
    var configuracion = {
      margin: 0,
      filename: "Remision" + ordenSeleccionado.id_rem + ".pdf",
    ...
    <div className={styles.modal}>
      ...
      <div className="container" id="pdf react" >
        <page>
          ...
          <Grid container spacing={2} >
            ...
            <Grid item xs={12} md={4}>
              <Typography align="center" className={styles.typography} variant="button" display="block" >
                GIM CLOUD LOGISTRAL S.A. - REMISION # {ordenSeleccionado.id_rem}
              </Typography>
            </Grid>
          </Grid>
          ...
          <Grid container spacing={1} >
            <Grid item xs={12} md={6} >
              <Button>CELULAR : {ordenSeleccionado.celular_rem} </Button>
            </Grid>
            <Grid item xs={12} md={6} >
          ...
          <page_footer>
            ...
            <Grid container spacing={2} >
              <Grid item xs={12} md={4}>
                <Typography align="center" className={styles.typography2} display="block" >
                  Luces de Trabajo:_____
                </Typography>
              </Grid>
              <Grid item xs={12} md={4}>
                <Typography align="center" className={styles.typography2} display="block" >
                  Luz Strober:__________
                </Typography>
              </Grid>
              <Grid item xs={12} md={4}>
                <Typography align="center" className={styles.typography2} display="block" >
            ...
            <Grid container spacing={2} >
              <Grid item xs={12} md={4}>
                <Typography align="center" className={styles.typography2} display="block" >
                  Sensor de Impacto:____
                </Typography>
              </Grid>
              <Grid item xs={12} md={4}>
                <Typography align="center" className={styles.typography2} display="block" >
                  Alarma de Reversa:____
                </Typography>
              </Grid>
              <Grid item xs={12} md={4}>
                <Typography align="center" className={styles.typography2} display="block" >
                  Camas de Batería:_____
                </Typography>
              </Grid>
            </Grid>
            <Grid container spacing={2} >
