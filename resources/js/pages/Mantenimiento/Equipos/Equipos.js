...
*/
  ...
  */
  ...
  const equipoEditarTipoEquipo = (
    <div className={styles.modal}>
      ...
      <Grid container spacing={2} >
        ...
        <Grid item xs={12} md={6}> <TextField name="datoauxiliarcalidad_equ" label="Dato Auxiliar Calidad"
          fullWidth onChange={handleChange} value={equiposSeleccionado && equiposSeleccionado.datoauxiliarcalidad_equ} />
        </Grid>
      </Grid>
      <div align="right">
        <Button className={styles.button} color="primary" onClick={() => actualizarEquipo()} >Editar</Button>
        <Button className={styles.button2} onClick={() => abrirCerrarModalEditarTipoEquipo()}>Cancelar</Button>
      </div>
  ...
  const grabarFoto = (
    <FotosEquipos codigoequipo={listarCodigoEquipo} />
  )
