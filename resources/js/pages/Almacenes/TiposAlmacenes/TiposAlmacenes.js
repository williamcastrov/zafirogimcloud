...
function TiposAlmacenes() {
  ...
  const tipoAlmacenInsertar = (
    <div className={styles.modal}>
      ...
      <div align="right">
        <Button className={styles.button} color="primary" onClick={() => grabarTipoAlmacen()} >Insertar</Button>
  ...
  const tipoAlmacenEditar = (
    <div className={styles.modal}>
      ...
      <br />
      <div align="right">
        <Button className={styles.button} color="primary" onClick={() => actualizarTipoAlmacen()} >Editar</Button>
  ...
  const tipoAlmacenEliminar = (
    <div className={styles.modal}>
      ...
      <div align="right">
        <Button className={styles.button} color="secondary" onClick={() => borrarTipoAlmacen()}> Confirmar </Button>
