...
function CostosVariables() {
  ...
  const grabarParametrosCostos = async () => {
    ...
    if (formOk) {
      const res = await costosvariablesServices.save(parametrosCostosSeleccionado);
  ...
  const actualizarParametrosCostos = async () => {
    ...
    if (formOk) {
      ...
      const res = await costosvariablesServices.update(parametrosCostosSeleccionado);
  ...
  const parametroscostoInsertar = (
    <div className={styles.modal}>
      <Typography align="center" className={styles.typography} variant="button" display="block" >
        Agregar Parametro Costos Variables
      </Typography>
      ...
      <Grid item xs={12} md={12}>
        <TextField className={styles.inputMaterial} name="valorcosto_cvp" label="Valor Costo Variable" fullWidth
  ...
  const parametroscostoEditar = (
    <div className={styles.modal}>
      <Typography align="center" className={styles.typography} variant="button" display="block" >
        Actualizar Parametro Costos Variables
      </Typography>
      <Grid item xs={12} md={12}>
        <FormControl className={styles.formControl}>
          <InputLabel id="tipocosto_cvp">Tipos Costos</InputLabel>
  ...
  const parametroscostoEliminar = (
    <div className={styles.modal}>
      <p>Estás seguro que deseas eliminar Parametro Costos Variables <b>{parametrosCostosSeleccionado && parametrosCostosSeleccionado.id_cvp}</b>? </p>
      <div align="right">
