...
function FichaTecnica(props) {
  ...
  useEffect(() => {
    async function fetchDataFichaTecnica() {
      ...
      console.log("DATOS FICHA : ", res.data)
...
*/
    ...
    if (formOk) {
      ...
      if (res.success) {
        ...
        swal("Ficha Técnica", "Error Crando la Ficha Técnica!", "error", { button: "Aceptar" });
        console.log(res);
        abrirCerrarModalInsertar();
      }
    }
  ...
  const fichatecnicaInsertar = (
    <div className={styles.modal}>
      ...
      <Grid container spacing={2} >
        ...
        <Grid item xs={12} md={4}> <TextField name="bateriatraccion_fit" label="Voltaje de la Batería"
          fullWidth onChange={handleChange} />
        </Grid>
        ...
        <Grid item xs={12} md={4}>
          <FormControl className={styles.formControl}>
            <TextField name="tipoderuedafrontal_fit" label="Ingresar Datos Rueda Frontal"
              fullWidth onChange={handleChange} />
          </FormControl>
        </Grid>
        <Grid item xs={12} md={4}>
          <FormControl className={styles.formControl}>
            <TextField name="tipoderuedatrasera_fit" label="Ingresar Datos Rueda Trasera"
              fullWidth onChange={handleChange} />
          </FormControl>
        </Grid>
        <Grid item xs={12} md={4}>
          <FormControl className={styles.formControl}>
            <TextField name="tipoderuedatrasera_fit" label="Ingresar Datos Rueda de Giro"
              fullWidth onChange={handleChange} />
          </FormControl>
        </Grid>
      </Grid>
