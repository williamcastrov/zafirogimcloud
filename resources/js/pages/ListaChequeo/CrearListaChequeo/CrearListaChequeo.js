...
function CrearListaChequeo() {
  ...
  const [ordenSeleccionado, setOrdenSeleccionado] = useState({
    ...
    'empresa_otr': 1,
    'horometro_otr': 0,
    'iniciatransporte_otr': fechaactual,
    'finaltransporte_otr': fechaactual,
  ...
  useEffect(() => {
    async function fetchDataEmpresas() {
      ...
      //console.log("DATOS DE LA EMPRESA : ", res.data);
    }
    fetchDataEmpresas();
  }, [])
  ...
  const grabarListaChequeo = async () => {
    ...
    if ((ordenSeleccionado.tipooperacion_otr != 3) && (ordenSeleccionado.tipooperacion_otr != 4) && (ordenSeleccionado.tipooperacion_otr != 6) ) {
      ...
      if (formOk) {

        {
          ...
          setOrdenSeleccionado([{
            estado_otr: ordenSeleccionado.estado_otr,
            ...
            cliente_otr: cliente,
            operario_otr: ordenSeleccionado.operario_otr,
  ...
  const ordenInsertar = (
    <div className={styles.modal}>
      ...
      <Grid container spacing={2} >
        ...
        <Grid item xs={12} md={4}>
          <FormControl className={styles.formControl}>
            ...
            <Select
              ...
              fullWidth
              onChange={handleChange}
              onClick={(e) => contactosInterlocutor(cliente)}
              disabled="true"
        ...
        <Grid item xs={12} md={4}>
          <FormControl className={styles.formControl}>
            <InputLabel id="idselectcontactocontacto_otr">Contacto Cliente</InputLabel>
            <Select
              labelId="selectcontacto_otr"
              name="contacto_otr"
              id="idselectcontacto_otr"
              fullWidth
              onChange={handleChange}
      ...
      <br /><br />
      <div align="right">
        <Button className={styles.button} color="primary" onClick={() => grabarListaChequeo()} >Insertar</Button>
