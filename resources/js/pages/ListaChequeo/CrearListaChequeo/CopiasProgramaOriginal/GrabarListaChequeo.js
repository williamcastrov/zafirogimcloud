...
export default function MenuEquipos(props) {
    const { codigo_equ } = props.listarUnEquipo[0];
    console.log("DATOS DEL EQUIPO : ", codigo_equ)
    ...
    const abrirCerrarModalInsertar = () => {
        console.log("CODIGO DEL PROPIETARIO SELECCIONADO : ", propietario)
    ...
    const grabarOrden = async () => {
        ...
        if ((ordenSeleccionado.tipooperacion_otr != 3) && (ordenSeleccionado.tipooperacion_otr != 4)) {
            ...
            console.log("TIPO OPERACION : ", ordenSeleccionado.tipooperacion_otr)
        ...
        <div className={styles.modal}>
            ...
            <Grid container spacing={2} >
                ...
                <Grid item xs={12} md={4}> <TextField name="equipo_otr" label="Equipo"
                    fullWidth onChange={handleChange} disabled="true" defaultValue={codigo_equ} />
                </Grid>
                ...
                <Grid item xs={12} md={4}>
                    <FormControl className={styles.formControl}>
                        ...
                        <Select
                            ...
                            fullWidth
                            onChange={handleChange}
                            onClick={(e) => contactosInterlocutor(propietario)}
