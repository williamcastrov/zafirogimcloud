...
crearordenes.listotterminadas = async () => {    
    const urlList = baseUrl+"/listar_ordenesservterminadas"
    const res = await axios.get(urlList)
    .then(response=>{ return response.data; })
    .catch(error=>{ return error; })
...
crearordenes.ordenesasignadas = async () => {    
...
crearordenes.leeotmaquina = async (equipo_otr) => {    
    const urlList = baseUrl+"/leeotmaquina/"+equipo_otr
    const res = await axios.get(urlList)
    .then(response=>{ return response.data; })
    .catch(error=>{ return error; })
...
crearordenes.listOrdenesServCumplimiento = async () => {    
    const urlList = baseUrl+"/listar_ordenesservcumplimiento"
    const res = await axios.get(urlList)
    .then(response=>{ return response.data; })
    .catch(error=>{ return error; })
...
crearordenes.updatiempoparo = async (data) => {
    console.log("DATO PARO : ", data)
    const urlUpdate = baseUrl+"/updatiempoparo/"+data.id_otr
    const res = await axios.put(urlUpdate, data)
    .then(response=>{ return response.data; })
    .catch(error=>{ return error; })
